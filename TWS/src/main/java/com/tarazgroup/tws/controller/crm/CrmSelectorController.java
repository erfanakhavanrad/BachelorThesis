...
public class CrmSelectorController {
    ...
    @Operation(
            summary = "Retrieve all selectors by fieldID",
            description = "<code>Retrieve</code> all <i><b>selectors by fieldID</b></i>",
            security = @SecurityRequirement(name = "bearerAuth")
    )
    @GetMapping(value = "/fields/{fieldID}", produces = "application/json;charset=utf-8")
    public ResponseEntity<List<CrmSelector>> selectorsShowByFieldID(@PathVariable BigDecimal fieldID) {
        return ResponseEntity.ok(crmSelectorRepository.crmShowSelectorByFieldID(fieldID));
    }
    ...
    @GetMapping(value = "/fields/{fieldID}/{selectorID}", produces = "application/json;charset=utf-8")
    public ResponseEntity<CrmSelector> selectorShowByFieldID_SelectorID(@PathVariable BigDecimal fieldID, @PathVariable BigDecimal selectorID) {
        return ResponseEntity
                .ok()
                .body(crmSelectorRepository.crmShowSelectorByFieldID_SelectorID(fieldID, selectorID));
    }
    ...
    @DeleteMapping(value = "/fields/{fieldID}/{selectorID}", produces = "application/json")

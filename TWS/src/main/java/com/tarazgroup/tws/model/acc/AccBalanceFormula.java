...
@NamedStoredProcedureQuery(
        name = "AccShowBalanceFormula",
        procedureName = "AccShowBalanceFormula",
        resultClasses = {AccBalanceFormula.class},
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "AccInsBalanceFormula",
        procedureName = "AccInsBalanceFormula",
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "AccUpdBalanceFormula",
        procedureName = "AccUpdBalanceFormula",
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "AccDelBalanceFormula",
        procedureName = "AccDelBalanceFormula",
        parameters = {
                @StoredProcedureParameter(name = "FormulaID", type = BigDecimal.class, mode = ParameterMode.IN),
                @StoredProcedureParameter(name = "Result", type = BigDecimal.class, mode = ParameterMode.OUT),
                @StoredProcedureParameter(name = "LoginID", type = BigDecimal.class, mode = ParameterMode.IN),
...
@Entity
public class AccBalanceFormula extends TParams implements Serializable {
    @Id

...
@NamedStoredProcedureQuery(
        name = "PubShowFormulaTypeVoucher",
        procedureName = "PubShowFormulaTypeVoucher",
        resultClasses = {PubFormulaTypeVoucher.class},
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "PubInsFormulaTypeVoucher",
        procedureName = "PubInsFormulaTypeVoucher",
        parameters = {
                @StoredProcedureParameter(name = "FormulaDesc", type = String.class, mode = ParameterMode.IN),
...
@NamedStoredProcedureQuery(
        name = "PubUpdFormulaTypeVoucher",
        procedureName = "PubUpdFormulaTypeVoucher",
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "PubDelFormulaTypeVoucher",
        procedureName = "PubDelFormulaTypeVoucher",
        parameters = {
                @StoredProcedureParameter(name = "FormulaID", type = BigDecimal.class, mode = ParameterMode.IN),
                @StoredProcedureParameter(name = "Result", type = BigDecimal.class, mode = ParameterMode.OUT),
                @StoredProcedureParameter(name = "LoginID", type = BigDecimal.class, mode = ParameterMode.IN),
...
@Entity
public class PubFormulaTypeVoucher extends TParams implements Serializable {
    @Id

...
@NamedStoredProcedureQuery(
        name = "SaleShowMarketingManRouteByName",
        procedureName = "SaleShowMarketingManRouteByName",
        resultClasses = {SaleMarketingManRouteByName.class},
        parameters = {
...
@Entity
public class SaleMarketingManRouteByName extends TParams implements Serializable {

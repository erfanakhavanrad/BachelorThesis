...
@NamedStoredProcedureQuery(
        name = "InvShowVoucherHeaderXFields",
        procedureName = "InvShowVoucherHeaderXFields",
        resultClasses = {InvVoucherHeaderXFields.class},
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "InvInsVoucherHeaderXFields",
        procedureName = "InvInsVoucherHeaderXFields",
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "InvDelVoucherHeaderXFields",
        procedureName = "InvDelVoucherHeaderXFields",
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "InvUpdVoucherHeaderXFields",
        procedureName = "InvUpdVoucherHeaderXFields",
        parameters = {
                @StoredProcedureParameter(name = "XFieldID", type = BigDecimal.class, mode = ParameterMode.IN),
                @StoredProcedureParameter(name = "VoucherHeaderID", type = BigDecimal.class, mode = ParameterMode.IN),
                @StoredProcedureParameter(name = "CustomField26", type = String.class, mode = ParameterMode.IN),
...
@Entity
public class InvVoucherHeaderXFields extends TParams implements Serializable {
        @Id

...
@NamedStoredProcedureQuery(
        name = "AccShowAccountForBalanceR",
        procedureName = "AccShowAccountForBalanceR",
        resultClasses = {AccAccountForBalanceR.class},
        parameters = {
...
@Entity
public class AccAccountForBalanceR extends TParams implements Serializable {

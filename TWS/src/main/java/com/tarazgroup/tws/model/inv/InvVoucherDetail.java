...
import com.tarazgroup.tws.model.sale.Element;
...
@NamedStoredProcedureQuery(
        name = "InvShowVoucherDetail",
        procedureName = "InvShowVoucherDetail",
        resultClasses = {InvVoucherDetail.class},
        parameters = {
...
@Entity
public class InvVoucherDetail extends TParams implements Serializable {
    ...
    @Column(name = "InvRemain")
    private BigDecimal invRemain;
    ...
    private BigDecimal analysisValueField;
    ...
    private Boolean getIsQuantitative;
    ...
    @Column(name = "BaseHeaderID")
    private BigDecimal baseHeaderID;
    ...
    @Column(name = "RemainQWithTolerance")
    private BigDecimal remainQWithTolerance;

    @Column(name = "_RemainQ")
    private BigDecimal _RemainQ;

    @Column(name = "IsPromotion")
    private Boolean getIsPromotion;


//    @Column(name = "MppDID")
//    private BigDecimal mppDID;

//    @Column(name = "MppOPCProcessID")
//    private BigDecimal mppOPCProcessID;
...
//    @Column(name = "BuyDID")
//    private BigDecimal buyDID;
//
//    @Column(name = "SupplyType")
//    private Integer supplyType;

//    @OneToMany
//    private List<com.tarazgroup.tws.util.tabletype.TSerial> tSerials;
//    private List<TSerial> tSerials;

//    @OneToMany
    @Transient
    private List<TSerial> tSerial;
...
//    private List<Element> elements;
    ...
    public BigDecimal getInvRemain() {
        return invRemain;
    }

    public void setInvRemain(BigDecimal invRemain) {
        this.invRemain = invRemain;
    }
    ...
    public BigDecimal getAnalysisValueField() {
        return analysisValueField;
    }

    public void setAnalysisValueField(BigDecimal analysisValueField) {
    ...
    public Boolean getQuantitative() {
        return getIsQuantitative;
    }

    public void setQuantitative(Boolean quantitative) {
        getIsQuantitative = quantitative;
    }
    ...
    public BigDecimal getBaseHeaderID() {
        return baseHeaderID;
    }

    public void setBaseHeaderID(BigDecimal baseHeaderID) {
    ...
    public BigDecimal getRemainQWithTolerance() {
        return remainQWithTolerance;
    }

    public void setRemainQWithTolerance(BigDecimal remainQWithTolerance) {
        this.remainQWithTolerance = remainQWithTolerance;
    }

    public BigDecimal get_RemainQ() {
        return _RemainQ;
    }

    public void set_RemainQ(BigDecimal _RemainQ) {
        this._RemainQ = _RemainQ;
    }
    ...
    public void setPromotion(Boolean promotion) {
        getIsPromotion = promotion;
    }

    public Boolean getGetIsQuantitative() {
        return getIsQuantitative;
    }

    public void setGetIsQuantitative(Boolean getIsQuantitative) {
        this.getIsQuantitative = getIsQuantitative;
    }

    public Boolean getGetIsPromotion() {
        return getIsPromotion;
    }

    public void setGetIsPromotion(Boolean getIsPromotion) {
        this.getIsPromotion = getIsPromotion;
    }

//    public BigDecimal getMppDID() {
//        return mppDID;
//    }
//
//    public void setMppDID(BigDecimal mppDID) {
//        this.mppDID = mppDID;
//    }
...
//    public BigDecimal getMppOPCProcessID() {
//        return mppOPCProcessID;
//    }
//
//    public void setMppOPCProcessID(BigDecimal mppOPCProcessID) {
//        this.mppOPCProcessID = mppOPCProcessID;
//    }


    public List<TSerial> getTSerial() {
        return tSerial;
    }

    public void setTSerial(List<TSerial> tSerial) {

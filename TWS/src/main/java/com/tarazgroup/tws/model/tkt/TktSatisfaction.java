...
@NamedStoredProcedureQuery(
        name = "TktShowSatisfaction",
        procedureName = "TktShowSatisfaction",
        resultClasses = {TktSatisfaction.class},
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "TktInsSatisfaction",
        procedureName = "TktInsSatisfaction",
        parameters = {
                @StoredProcedureParameter(name = "SatisfactionName", type = String.class, mode = ParameterMode.IN),
...
@NamedStoredProcedureQuery(
        name = "TktUpdSatisfaction",
        procedureName = "TktUpdSatisfaction",
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "TktDelSatisfaction",
        procedureName = "TktDelSatisfaction",
        parameters = {
                @StoredProcedureParameter(name = "SatisfactionID", type = BigDecimal.class, mode = ParameterMode.IN),
                @StoredProcedureParameter(name = "Result", type = BigDecimal.class, mode = ParameterMode.OUT),
                @StoredProcedureParameter(name = "LoginID", type = BigDecimal.class, mode = ParameterMode.IN),
...
@Entity
public class TktSatisfaction extends TParams implements Serializable {
    @Id

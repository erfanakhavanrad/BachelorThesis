...
@NamedStoredProcedureQuery(
        name = "TktShowTicketStatusReport",
        procedureName = "TktShowTicketStatusReport",
        resultClasses = {TktTicketStatusReport.class},
        parameters = {
...
@NamedStoredProcedureQuery(
        name = "TktShowTicketStatusReportForStaff",
        procedureName = "TktShowTicketStatusReportForStaff",
        resultClasses = {TktTicketStatusReport.class},
        parameters = {
                @StoredProcedureParameter(name = "Filter", type = String.class, mode = ParameterMode.IN),
                @StoredProcedureParameter(name = "UserID", type = BigDecimal.class, mode = ParameterMode.IN),
...
@NamedStoredProcedureQuery(
        name = "TktShowTicketStatusReportForCustomer",
        procedureName = "TktShowTicketStatusReportForCustomer",
        resultClasses = {TktTicketStatusReport.class},
        parameters = {
                @StoredProcedureParameter(name = "Filter", type = String.class, mode = ParameterMode.IN),
                @StoredProcedureParameter(name = "UserID", type = BigDecimal.class, mode = ParameterMode.IN),
...
@Entity
public class TktTicketStatusReport extends TParams implements Serializable {

...
import com.tarazgroup.tws.model.tkt.TktTicketPriorityReport;
 ...
 */
public interface TktTicketPriorityReportRepository extends TCrudRepository<TktTicketPriorityReport>, CrudRepository<TktTicketPriorityReport, BigDecimal> {
    default TChartTicketPriority tktTicketPriorityReport(
            String xFieldName,
            String[] yFieldNames,
            String[] yFieldTitles,
            String fromDate,
...
//        }
        ...
        List<Map<String, Object>> rows = execSPNativeQuery(TktTicketPriorityReport.class, "TktShowTicketPriorityReport", tParameters, ShowSPReturnType.MAP);
        return new TChartTicketPriority(xFieldName, yFieldNames, yFieldTitles, rows);

    }

    default TChartTicketPriority tktTicketPriorityReportForCustomer(
            String xFieldName,
            String[] yFieldNames,
            String[] yFieldTitles
    ) {
        ...
        List<Map<String, Object>> rows = execSPNativeQuery(TktTicketPriorityReport.class, "TktShowTicketPriorityReportForCustomer", tParameters, ShowSPReturnType.MAP);
        return new TChartTicketPriority(xFieldName, yFieldNames, yFieldTitles, rows);
    }

    default TChartTicketPriority tktTicketPriorityReportForStaff(
            String xFieldName,
            String[] yFieldNames,
            String[] yFieldTitles
    ) {
        ...
        List<Map<String, Object>> rows = execSPNativeQuery(TktTicketPriorityReport.class, "TktShowTicketPriorityReportForStaff", tParameters, ShowSPReturnType.MAP);
        return new TChartTicketPriority(xFieldName, yFieldNames, yFieldTitles, rows);
    }

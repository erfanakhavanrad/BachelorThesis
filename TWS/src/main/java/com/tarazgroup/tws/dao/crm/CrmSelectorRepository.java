...
public interface CrmSelectorRepository extends TCrudRepository<CrmSelector>, CrudRepository<CrmSelector, BigDecimal> {
    ...
    default CrmSelector crmShowSelectorByFieldID_SelectorID(BigDecimal fieldID, BigDecimal selectorID) {
        List<TParameter<?>> tParameters = new ArrayList<>();
        tParameters.add(new TParameter<>("Filter", " AND Main.fieldID=" + fieldID + "AND Main.SelectorID = " + selectorID));
        tParameters.add(new TParameter<>("OtherFilter", null));
        tParameters.add(new TParameter<>("ServerFilter", null));
        tParameters.add(new TParameter<>("YearFilter", null));
        tParameters.add(new TParameter<>("UserAccessFilter", null));
    ...
    default Meta meta() {
        ...
        cols.add(new Col(null, "fieldTitle", "نام فیلد", Type.STRING, 0, false, false, false));
        cols.add(new Col(null, "selectorValue", "مقدار", Type.COLOR, 100, true, true, false));
        cols.add(new Col(null, "color", "رنگ", Type.COLOR, 120, false, false, false));
